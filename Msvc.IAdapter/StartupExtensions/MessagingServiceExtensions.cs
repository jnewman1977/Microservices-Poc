...
namespace Msvc.IAdapter.StartupExtensions;

public static class MessagingServiceExtensions
{
    public static IServiceCollection AddMessagingConfigurtion(this IServiceCollection services, bool isRunningInContainer)
    {
    ...
    public static IServiceCollection AddMessagingDependencies(this IServiceCollection services)
    {
        services
            ...
            .AddTransient<IIAdapterFactory, IAdapterFactory>()
